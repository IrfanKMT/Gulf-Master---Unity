...
#pragma warning restore 618
        ...
        void SetupServer()
        {
            ...
            Debug.Log("Max Connection  "+maxConnections);
...
#pragma warning restore 618
            ...
            {
                //Debug.Log("No authenticator found");
            }
        ...
        {
            print("Starting Client Network Manager");
...
#pragma warning restore 618
        ...
        void RegisterClientMessages()
        {
            ...
            {
                print("playerPrefab is inistantiating");
                NetworkClient.RegisterPrefab(playerPrefab);
            }
            else
            {
                print("playerPrefab is null");
            }
        ...
        void OnClientDisconnectInternal()
        {
            ...
            Debug.Log("NetworkManager StopClient "+mode);
            OnStopClient();
