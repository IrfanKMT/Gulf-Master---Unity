...
namespace Thinksquirrel.CShake
{
    ...
    public class CameraShake : CameraShakeBase
    {
        ...
        [Header("Shake Amount For Bombs")]
        [SerializeField] public Vector3 m_ShakeAmountRocket = Vector3.one;
        [SerializeField] public Vector3 m_ShakeAmountElectric = Vector3.one;
        [SerializeField] public Vector3 m_ShakeAmountBomb = Vector3.one;
